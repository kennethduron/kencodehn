...
test("badge recibe notificaciones ya scoped por servidor", () => { const tasksPage = readFileSync("src/app/admin/tareas/page.tsx", "utf8"); assert.match(tasksPage, /listNotifications\(admin\)/); assert.match(tasksPage, /notifications\.filter/); });
