...
export function AuthShell({ title, description, children }: { title: string; description: string; children: React.ReactNode }) {
  return (
    <main className="kc-admin-theme grid min-h-screen place-items-center overflow-x-hidden bg-kc-bg px-4 py-8 sm:px-6">
      <section className="w-full max-w-md rounded-2xl border border-kc-cyan/20 bg-kc-bg-soft p-5 shadow-[0_24px_70px_rgba(15,35,63,0.14)] sm:p-7">
