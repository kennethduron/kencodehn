...
const reports=["collections","receivables","overdue","expenses","cash_result","project_sales","seller","module_sales","module_collected","module_outstanding","module_recurring"];
