...
function mapReminderTask(doc: QueryDocumentSnapshot<DocumentData>): AdminTask {
  ...
  return {
    ...
    relationType: data.clientId ? "client" : data.leadId ? "lead" : null,
    relationId: data.clientId ? String(data.clientId) : data.leadId ? String(data.leadId) : null,
    relationName: data.clientName ? String(data.clientName) : data.leadName ? String(data.leadName) : null,
