...
export const ROLE_PERMISSIONS: Record<AdminRole, readonly AdminPermission[]> = {
  ...
  manager: ["leads:view", "leads:edit", "clients:view", "clients:edit", "projects:view", "projects:edit", "commercial_plans:view", "recurring_services:view", "billing:view", "reports:view"],
  viewer: ["leads:view", "clients:view", "projects:view", "commercial_plans:view", "recurring_services:view", "billing:view"],
  sales_agent: [
    "leads:view",
    "leads:edit",
    "clients:view",
