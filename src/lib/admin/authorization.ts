...
export const ROLE_PERMISSIONS: Record<AdminRole, readonly AdminPermission[]> = {
  ...
  manager: ["leads:view", "leads:edit", "leads:assign", "clients:view", "clients:edit", "clients:assign", "projects:view", "projects:edit", "projects:assign", "commercial_plans:view", "recurring_services:view", "billing:view", "payments:manage", "billing:correct_future", "finance:view", "reports:view", "reports:export", "modules:view", "modules:draft", "modules:manage", "notes:view", "notes:edit", "tasks:view", "tasks:edit", "activity:view", "notifications:view", "notifications:edit", "mail:use", "mail:supervise", "mail:assign_threads", "records:delete_empty", "records:archive"],
